...
export const Input = () => {
  ...
  const [dateInput, setDateInput] = useState(new Date().toLocaleString().slice(0, 19).replaceAll("/", "-").replace(",", "")); // State for datetime-local input. Initial state is the current date
